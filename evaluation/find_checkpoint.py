...
# 임계값 설정 tau x
delta1_threshold_arr = [0.935, 0.979, 0.980, 0.750, 0.977]
abs_relative_difference_threshold_arr = [0.084,0.045,0.055,0.250,0.045]
...
# delta1_threshold_arr = [0.935]
# abs_relative_difference_threshold_arr = [0.084]
...
for name, delta1_threshold, abs_relative_difference_threshold, in zip(data_name_arr, delta1_threshold_arr,abs_relative_difference_threshold_arr):
    ...
    # 파일 경로 설정 tau 3
    file_path = f'output/{name}/eval_metrics-bfm-ddp-compress_0101.txt'
    # 체크포인트를 저장할 리스트
    checkpoints = []
