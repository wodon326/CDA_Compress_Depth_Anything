...
if "__main__" == __name__:
    ...
    if "depth_anything" in model_type:
        if("v2" in model_type):
            ...
            model.load_state_dict(torch.load(f'/home/wodon326/datasets/AsymKD_checkpoints/depth_anything_v2_{encoder}.pth', device))
        ...
        restore_ckpt = '/home/wodon326/project/BriGeS-Depth-Anything-V2/best_checkpoint/19000_AsymKD_new_loss.pth'
